...
#bwMapViewport .bwV76HuntTodayFixed{position:absolute!important;right:10px!important;top:154px!important;bottom:auto!important;left:auto!important;z-index:155!important;transform:none!important;margin:0!important}
@media(min-width:601px){#bwMapViewport .bwV76HuntTodayFixed{top:164px!important}}
` ;document.head.appendChild(st)}
function moveHuntToday(){const v=document.querySelector(VIEW);if(!v)return;const property=document.getElementById('property');const active=property?.classList.contains('active');const el=document.getElementById('bwV63Today');if(!el)return;if(active){if(el.parentElement!==v)v.appendChild(el);el.classList.add('bwV76HuntTodayFixed');el.style.position='absolute';el.style.right='10px';el.style.top='154px';el.style.bottom='auto';el.style.left='auto';el.style.zIndex='155';el.style.transform='none';el.style.margin='0'}else{if(el.parentElement!==document.body)document.body.appendChild(el);el.classList.remove('bwV76HuntTodayFixed');el.style.position='fixed';el.style.right='12px';el.style.top='122px';el.style.bottom='auto';el.style.left='auto';el.style.zIndex='105';el.style.transform='none';el.style.margin='0'}}
