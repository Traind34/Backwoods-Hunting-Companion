(function(){'use strict';
function loadScript(src){return new Promise(function(resolve){var s=document.createElement('script');s.src=src;s.onload=function(){resolve(true)};s.onerror=function(){console.warn('Backwoods script unavailable:',src);resolve(false)})}
...
function loadBackupGuard(){return loadScript('bw-v20-backup-guard.js')}
