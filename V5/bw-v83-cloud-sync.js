(function(){
  ...
  function meaningful(d){return !!d&&(!!d.property?.name||!!d.boundary||(d.hunts||[]).length||(d.stands||[]).length||(d.cameras||[]).length||(d.deerSightings||[]).length||(d.observations||[]).length)}
